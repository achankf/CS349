...
public class Config{
	...
	public final static Dimension DEFAULT_DIM = new Dimension (1024,768);
	public final static Dimension DEFAULT_CANDY_MIN_DIM = new Dimension(50,50);
	public final static int CANDY_RANDOM_BOUND = 50;
	public final static int NUM_CANDIES = 20;

	public final static Dimension DOOZER_BODY_DIM = new Dimension (200,100);
	...
	public final static int FALL_SPEED = 1;
